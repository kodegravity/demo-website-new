export default function Home() {
  return (
    <main>
      <section className="hero" id="top">
        ...
        <div className="hero-content page-width">
          ...
          <div className="hero-visual delivery-brief" aria-label="Quantorule delivery brief">
            <div className="brief-heading">BUILT AROUND YOUR OPERATION</div>
      ...
      <footer className="footer"><div className="page-width footer-grid"><div><a className="brand brand-footer" href="#top"><span className="brand-mark" aria-hidden="true">Q</span><span>Quantorule</span></a><p>Software, cloud, and IT systems built for growing businesses.</p></div><div><span className="footer-label">CONTACT</span><a href="mailto:info@quantorule.com">info@quantorule.com</a><span>10 Four Seasons Pl Suite 1000, Etobicoke, ON M9B 6H7</span></div><div><span className="footer-label">NAVIGATE</span><a href="#services">Services</a><a href="#approach">Approach</a><a href="#contact">Contact</a></div></div><div className="page-width footer-bottom"><span>© 2026 Quantorule. All rights reserved.</span><span>Built with intention.</span></div></footer>
    </main>
  );
}
